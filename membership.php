            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                <div class="list">
                      <div class="typer">
                          ...
                          <div class="range">
                            <p>
                            <?=$pack['month']?> Month<span> $<?=$pack['price']?></span>
                            </p>
                          </div>
                          <div class="get">
                          <?php
                          ...
                          ?>
                            <a href="payment.php?pack_id=<?=$pack['id']?>" class="btn-primary">
                                                        Get Started
                                                      </a>
                          <?php
                          }else {?>
            ...
            <!-- <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                <div class="list">
                    <div class="typer">
                      ...
                      <div class="range">
                        <p>
                          6 month <span>$90</span>
                        </p>
                      </div>
                      <div class="get">
                      <a href="payment.php?pack_id=2" class="btn-primary">
                          Get Started
                        </a>
                      </div>
                    </div>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
              <div class="list">
                  <div class="typer">
                    ...
                    <div class="range">
                      <p>
                        1 Year <span>$190</span>
                      </p>
                    </div>
                    <div class="get">
                    <a href="payment.php?pack_id=3" class="btn-primary">
                        Get Started
                      </a>
                    </div>
                  </div>
