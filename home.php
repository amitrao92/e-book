        ...
        <div class="col-12 p-0">
          <div class="slider_area">
            <div class="banner_sliders">
              <div class="img_area">
                <div class="img_box">
                  <img src="asset/img/banner_01.jpg" alt=".." />
                </div>
              </div>
              <div class="img_area">
                <div class="img_box">
          ...
          <div class="row">
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
              <div class="books">
                <a href="javascript:;">
                  ...
                  <div class="label">
                   <a href="books.php"> <p>Free Book</p></a>
                  </div>
                </a>
              </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
              <div class="books">
                <a href="javascript:;">
                  <div class="img_area">
                    <img src="asset/img/member.jpg" alt=".." />
                  </div>
                  <div class="label">
                  <a href="membership.php"><p>Membership Plans</p></a>
                  </div>
                </a>
              </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
              <div class="books">
                <a href="javascript:;">
                  <div class="img_area">
                    <img src="asset/img/mzn.jpg" alt=".." />
                  </div>
                  <div class="label">
                  <a href="books.php"> <p>Trending Magazine</p></a>
                  </div>
                </a>
              </div>
            </div>
